  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/blog/say-youve-said-hello',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: '/complaints-comments-compliments-policy.pdf',
        permanent: true,
      },
      ...
      {
        source: '/global-mediation-safeguarding-policy',
        destination: '/services',
        permanent: true,
      },
      {
        source: '/send-mediation-professional-practice-area',
        destination: '/send-mediation',
        permanent: true,
      },
      ...
      {
        source: '/child-friendly-safeguarding-policy',
        destination: '/family-mediation',
        permanent: true,
      },
    ];
