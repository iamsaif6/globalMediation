...

  {
    ...
    details: (
      <p>
        ...
        experience, he brings a rare blend of analytical insight and human understanding to the organisation. <br /> <br />
        ...
        successful accountancy firm supporting owner-managed and family-run businesses. <br /> <br />
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        educational and child psychologists. <br /> <br />
        ...
        Questions (2012), and Resolving Disagreement in Special Needs (2003). <br /> <br />
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        sectors including supply chain, manufacturing, the NHS, and both local and national government. <br /> <br />
...

  {
    ...
    details: (
      <p>
        ...
        process. She is on the panel for the CoM Practice Standards Committee and also for the SEND Mediation Assessors/DfE. <br /> <br />
...
const mediator = [
  {
    ...
    details: (
      <p>
        Rebecca combines a calm, supportive style with professional clarity to deliver impartial, well-structured SEND mediations. She
        creates safe, respectful environments where all parties feel heard — managing the process with warmth, fairness and a focus on
        moving forward. <br /> <br />
        As a highly experienced mediator, Rebecca helps families, local authorities, schools and professionals work together with the child
        or young person at the centre of every conversation.
      </p>
    ),
  },

  {
    ...
    details: (
      <p>
        Nigel is a highly experienced SEND mediator who has conducted over 1,000 mediations since 2013. Known for his calm, consistent
        approach, he continues to support families and professionals to navigate complex issues and find positive, forward-focused outcomes.
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        Suneta is a highly experienced mediator specialising in SEND and workplace resolution, with a strong focus on the education sector.
        She brings empathy, clarity and professionalism to every case — helping individuals and teams navigate challenges, strengthen
        communication and build lasting solutions.
      </p>
    ),
  },

  {
    ...
    details: (
      <p>
        Janet brings deep expertise in SEND, built over a career as a teacher, advisor and manager in the sector before training as a
        mediator. She is known for her calm, grounded approach, clear subject knowledge and ability to listen with care — helping
        participants feel heard, supported and confident throughout the process.
      </p>
    ),
  },

  {
    ...
    details: (
      <p>
        Nikeisha is a trained mediator with a strong background in case management and family support. Since joining Global Mediation in
        2017, she has progressed from Case Manager to Area Lead, and now forms part of the IH Mediation team. <br /> <br />
        Having completed both the Foundation and SEND Mediation courses, Nikeisha brings a calm, structured approach to every case. She is
        committed to guiding families through the mediation process with empathy, clarity and care.
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        Altaf is a CMC-qualified mediator with a strong background in SEND and community mediation. He brings over two decades of experience
        across education and local government, with a particular focus on supporting young people with special educational needs and
        learning difficulties.
        <br /> <br />
        Holding an MPhil in Law, Altaf blends academic rigour with practical expertise in empathy, communication and collaborative
        problem-solving. He is committed to creating safe, transparent spaces where individuals feel empowered to resolve conflict
        constructively and reach lasting outcomes.
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        Jo brings warmth, empathy and a deep belief in the power of mediation to every case. Known for her calm presence and strong
        communication skills, she helps participants feel supported and heard — empowering them to work together toward fair and lasting
        outcomes
      </p>
    ),
  },
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 lg:gap-6">
          {members.map((item, idx) => (
            <div key={idx} className="px-5 min-h-[250px] lg:px-[25px]   mb-[20px]">
              <div className=" max-w-[350px] md:max-w-full mx-auto h-[350px] w-full rounded-3xl overflow-hidden bg-gray-200">
                {item?.image && <Image className="object-cover object-top h-full w-full" alt={item.name} src={item.image} />}
              </div>
              <h3 className={` mt-3 truncate md:mt-6 text-2xl md:text-[32px] font-semibold `}>{item.name}</h3>
