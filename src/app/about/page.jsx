  ...
  return (
    <div className="bg-[#F9F8FF]">
      <Head>
        ...
        <meta
          itemprop="name"
          content="About - Global Mediation - Mediation Services UK"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.globalmediation.co.uk/about/"
        />
      ...
      <header
        style={{
          backgroundImage: `url('/about-bg.jpg'), linear-gradient(to right, rgba(62,0,101,0.60) 1.68%, rgba(62,0,101,0.15) 69.4%)`,
          backgroundBlendMode: "overlay",
          backgroundSize: "cover",
          backgroundPosition: "right top",
        }}
        className=" pt-[187px] max-h-[1050px] flex items-center h-screen bg-no-repeat relative md:pt-[238px] pb-[176px] md:pb-[203px] px-5 md:px-[60px]">
