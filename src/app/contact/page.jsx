...
const metadata = {
  title:
    "Contact Us | Global Mediation - Mediation Services in London & Nationwide",
  description:
  ...
  return (
    <div className=" bg-gray-100">
      <div
        ...
        <div className="grid flex-1 grid-cols-12 gap-6 pt-16 px-5 md:px-16 md:pt-[80px]">
          <div className="col-span-12 lg:col-span-7 flex items-center">
            <div className="text-center mb-10">
              <h1 className="leading-[120%] text-5xl md:[55px] lg:text-[65px] font-semibold mb-4 !text-white ">
          ...
          <div className="col-span-12 lg:col-span-5">
            <form
              ref={formRef}
              onSubmit={sendEmail}
              className="md:space-y-4 text-black  rounded-3xl border-2 border-[#E7E7F1] py-5 px-4 lg:px-8 bg-white space-y-3 ">
              <h2 className="text-3xl text-center font-semibold mb-6 opacity-80">
                Get in touch
              </h2>
              <div>
                <input
        ...
        <div className="grid text-black  mt-10 mb-10  grid-cols-3 gap-10 pb-16 px-5 md:px-16 md:pb-[20px] ">
          <div className="col-span-3 lg:col-span-1 flex gap-5 items-center">
            <Check className="text-primary flex-shrink-0" />
            <p className=" font-normal  text-[15px]">
              <strong>Free</strong> , no-obligation consultation to understand
              your needs and explain how we can help.
            </p>
          </div>
          ...
          <div className="col-span-3 lg:col-span-1 flex gap-5 items-center">
            <Check className="text-primary flex-shrink-0" />
            <p className=" font-normal text-[15px]">
              <strong> Tailored support from real experts</strong> — every
              inquiry is reviewed by an experienced case manager.
            </p>
          </div>
          ...
          <div className="col-span-3 lg:col-span-1 flex gap-5 items-center">
            <Check className="text-primary flex-shrink-0" />
            <p className=" font-normal text-[15px]">
              <strong> Trusted by Thousands</strong> . We’ve helped resolve over
              20,000 disputes across the UK — from families and businesses to
              government bodies.
            </p>
          </div>
        </div>
          ...
          <div className="z-10 py-10 mx-auto text-white text-center">
            <div className="z-10 relative">
              <div className="max-w-[950px] mx-auto">
                <h1 className="font-medium text-4xl md:text-[54px] leading-[120%] mb-[20px] md:mb-6">
                  Let’s find a way forward, together
                </h1>
                <p className=" text-base md:text-lg">
                  For more information about our services, team, training
                  programmes, or career opportunities, get in touch with us.
                </p>
              </div>
              <div
                className={`mt-8 md:max-w-[950px] grid grid-cols-1 md:grid-cols-2  gap-4  mx-auto`}>
                <button className="bg-primary font-semibold text-[#FCFCFD] px-10 py-3 rounded-[40px] text-base md:text-lg">
                  <Link
                    ...
                    href="mailto:send@globalmediation.co.uk">
                ...
                <button className="font-semibold border border-white text-base md:text-lg text-white px-6 py-3 rounded-[40px]">
                  <Link
                    className=" w-full text-center flex items-center gap-2 justify-center"
                    href="tel:020 8441 1355">
                    <Phone size={20} />
                    020 8441 1355
                  </Link>
                </button>
