...
const headerBG = "/brand-value-bg.jpg";
const values = [
  {
    title: "Quality",
      ...
      <header
        ...
        <div>
          ...
          <p className="text-white mt-[25px] md:mt-4 mb-[25px] mr-auto max-w-[700px] md:mb-10 w-[100%] font-normal text-base md:text-lg xl:text-xl">
            At Global Mediation, our values guide everything we do, from how we
            support people through challenging situations, to the care and
            commitment we bring to every conversation. They reflect the service
            we aim to deliver, and the impact we hope to have.
          </p>
        </div>
      </header>
          ...
          {values.map((item, idx) => (
            <motion.div
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="font-semibold text-[#43006A] text-2xl mb-3">
                  {item.title}
                </h3>
