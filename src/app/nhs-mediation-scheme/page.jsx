...
export const metadata = {
  title: 'NHS Resolution Mediation Service',
  description:
      ...
      >
        ...
        <div className="text-center order-1 lg:order-2 lg:text-left  relative z-10 ">
          ...
          <p className="  justify-center lg:justify-start  items-center text-sm lg:text-base text-black">
            ...
            Global Mediation has been appointed by NHS Resolution to provide independent mediation services to the NHS for the resolution of
