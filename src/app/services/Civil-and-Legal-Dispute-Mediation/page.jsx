...
const page = () => {
  return (
    <div>
      <Header
        title={'Civil & Legal Dispute Mediation'}
        subTitle={'A practical, impartial way to resolve legal disagreements without the time, stress, and cost of going to court.'}
        Button1Text={'Speak to a Civil Mediation Specialist'}
