...
export const metadata = {
  title:
    "Business and Commercial Mediation | Global Mediation - Mediation Services in London & Nationwide",
  description:
...
const service2 = "/example-mediated.jpg";
// const service3 = 'https://global-mediation.s3.eu-west-2.amazonaws.com/large-files/dylan-gillis-KdeqA3aTnBY-unsplash.jpg';
const cover =
  "https://global-mediation.s3.eu-west-2.amazonaws.com/large-files/Business_Header.jpeg";
...
const faqData = [
  {
    ...
    answer:
      "Most sessions last a full day, depending on the complexity of the dispute. Preparation and follow-up are included.",
  },
  {
    key: 2,
  ...
  },
  {
    ...
    answer:
      "No, but legal advisors can be included if you prefer. The process is designed to be flexible, accessible and collaborative.",
  },
  {
    key: 4,
...
const item3 = {
  ...
  subtitle:
    "We work with individuals, teams and organisations to resolve disputes such as:",
  service: [
    ...
    <div>
      ...
      <div className={` py-10 md:py-[80px] px-5 md:px-[60px]`}>
        <div className="text-left md:text-center">
          <h2 className="w-full  mb-10 font-medium text-4xl md:text-5xl leading-[120%] ">
            {item.title}
          </h2>
          <p className="mb-[32px] md:mb-[60px] text-black text-base md:text-lg leading-[150%] my-6">
            {item.subtitle}
          </p>
        </div>
      ...
      <div className={` py-10 md:py-[80px] px-5 md:px-[60px]`}>
        <div className="text-left md:text-center">
          <h2 className="w-full  mb-14 font-medium text-4xl md:text-5xl leading-[120%] ">
            {item3.title}
          </h2>
        </div>
        <div className="grid grid-cols-2 items-center  gap-8 md:gap-[100px]">
      ...
      <FAQ
        title={"FAQs About Business and Commercial Mediation"}
      ...
      <div className="bg-[#F9F8FF]">
        <CTA
          ...
          subTitle={
            "You don’t need to know exactly what you’re asking for. Just tell us what’s going on, and we’ll talk you through it."
          }
          Button1Link={"/contact"}
