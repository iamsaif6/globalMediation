        ...
        <div className="z-10 py-10 mx-auto text-white text-center">
          <div className="z-10 relative">
            ...
            <div className={`mt-8 md:max-w-[950px] ${Button2Text ? 'grid grid-cols-1 md:grid-cols-2' : 'md:grid-cols-1'}  gap-4  mx-auto`}>
              {Button1Text && (
                <button className="bg-primary capitalize  font-semibold text-[#FCFCFD] px-6 py-3 rounded-[40px] text-lg">
              ...
              {Button2Text && (
                <button className="font-semibold capitalize border border-white text-lg text-white px-6 py-3 rounded-[40px]">
