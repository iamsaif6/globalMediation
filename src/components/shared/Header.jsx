  ...
  return (
    <header className="pt-[187px] md:pt-[238px] pb-[176px] md:pb-[203px] px-5 md:px-[60px] relative overflow-hidden bg-amber-700">
      {isHomePage ? (
        ...
        <div
          className="absolute top-0 left-0 w-full h-full z-0 bg-gradient-to-r from-[rgba(62,0,101,0.80)] via-[rgba(62,0,101,0.4)] to-[rgba(62,0,101,0.15)]"
          style={{
      ...
      <div className="w-full lg:max-w-[80%] relative z-20">
        <h1 className="font-semibold tracking-[-4%] leading-[120%] text-5xl md:text-[65px] lg:text-[84px] text-white">{title}</h1>
        <p className="text-white mt-[18px] md:mt-6 mb-[26px] md:mb-8 w-[70%] font-normal text-sm md:text-lg">{subTitle}</p>
        <div className="flex md:flex-row flex-col items-center gap-4">
          {Button1Text && (
            <button className="bg-primary border w-full md:w-auto border-primary font-normal text-lg text-[#FCFCFD] px-12 py-3 rounded-[40px]">
