  ...
  return (
    <header
      style={{
        ...
        }'), linear-gradient(to right, rgba(62,0,101,0.80) 1.68%, rgba(62,0,101,0.15) 69.4%)`,
    ...
    >
      ...
      <div className="w-full relative z-10 lg:max-w-[80%]">
        <h1 className="font-semibold tracking-[-4%] leading-[120%] text-5xl md:[65px] lg:text-[72px] text-white">{title}</h1>
