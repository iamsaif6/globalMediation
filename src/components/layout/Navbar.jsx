...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed z-[50] lg:max-w-[1318px] rounded-[20px] border-[0.5px] border-primary left-1/2 -translate-x-1/2 w-full mx-auto bg-white max-w-[90%] top-5 lg:rounded-4xl overflow-hidden">
