      ...
      <nav className="fixed z-50 md:max-w-[1380px] border border-primary left-1/2 -translate-x-1/2 w-full mx-auto  bg-white max-w-[90%] top-5 rounded-4xl overflow-hidden ">
        <div className="flex items-center justify-between py-[7px] md:py-3 md:pl-9 px-[18px] md:px-3">
          <div className="flex items-center gap-10 relative">
            ...
            <ul className="md:flex relative hidden gap-6 text-secondary font-normal text-lg items-center">
              {navLinks.map(link => {
                return (
                  <li key={link.href} onClick={() => setActiveMenu(true)}>
        ...
        {activeMenu && (
          <div
            ...
            className="  bg-white left-0 w-full bg-lavender-50 border-t-[0.5px] border-[#E2DEDE] transition-all duration-300 opacity-100 transform translate-y-0 z-50"
          >
            <div className="grid grid-cols-12">
              <div className="col-span-5 p-8 space-y-4">
                <button
                  ...
                  } flex cursor-pointer items-start flex-col w-full p-6 rounded-xl text-secondary`}
                >
              ...
              <div className="col-span-7 p-8 bg-[#F3F1FF]">
                <h3 className="text-xl font-semibold mb-4">Mediation Services</h3>
