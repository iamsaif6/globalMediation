...
import GtLogo from '/public/GT-Logo.png';
...
const traiingSubmenu = [
  { title: 'Learn more about Global Training', href: 'https://www.globaltraining.uk/' },
  // { title: 'SEND mediation training course', href: 'https://www.globaltraining.uk/' },
  // { title: 'SEND mediation professional practice', href: https://www.globaltraining.uk/' },
];
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-5 p-8 space-y-4">
                ...
                >
                  ...
                  <span className="text-sm">Practical, values-led training in mediation, communication and courageous leadership.</span>
                </Link>
              </div>
