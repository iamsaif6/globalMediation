...
import service3 from '/public/annie-spratt-4A1pj4_vClA-unsplash.jpg';
  ...
  return (
    <div className="mb-[40px] ">
      {services.map((item, index) => (
        <div key={item + index} className={`${index % 2 != 0 ? 'bg-[#F3F1FF]' : 'bg-[#F9F8FF]'} py-8 md:py-[80px] px-5 md:px-[60px]`}>
          ...
          <div className="grid grid-cols-2 items-center  gap-8 md:gap-[100px]">
            ...
            <div className="col-span-2 order-1 lg:col-span-1 overflow-hidden   h-[353px] lg:h-[503px] rounded-[40px] relative">
              {item?.image && (
