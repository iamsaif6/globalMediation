...
const service2 =
  "https://global-mediation.s3.eu-west-2.amazonaws.com/large-files/training-2.jpg";
        ...
        <>
          <div key={idx} className=" grid items-center grid-cols-2 gap-[80px]">
            <div className="col-span-2 lg:col-span-1">
              <h3 className="font-semibold text-[24px] mb-[30px]  md:text-[32px] leading-[120%]">
                {idx + 1 + ". " + item.title}
              </h3>
              ...
              <p className=" text-base mb-5 md:text-lg leading-[150%]">
                {item.description}
              </p>

              <div>
                <h3 className="md:text-2xl text-lg font-medium text-secondary my-6 ">
                  Key Benefits:
                </h3>
