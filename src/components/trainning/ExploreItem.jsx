...
const service4 = '/prectice-days-cover.jpg';
const service5 = '/GlobalMediation_actors-178.jpg';
...
const exlopreItem = [
  ...
  {
    title: 'Accredited Supervision Course',
    description:
      'A two-day advanced course for experienced mediators who want to deepen their practice and qualify as Professional Practice Consultants (PPCs). This course combines high-quality training with real-world application, equipping you to supervise, support and challenge others across a range of mediation settings. Applicants must be fully accredited mediators with current experience and evidence of good practice.',
    key: [
      'Reflective Supervision Skills – Learn how to support mediators and trainees through reflective practice, ethical considerations and safeguarding.',
      'Practical, Interactive Format – Delivered live over Zoom, with immersive group learning and expert-led guidance.',
    ],
    cover: service5,
    buttonText: 'Advance your Supervision Skills today',
    buttonLink: '/contact',
  },
];
  ...
  return (
    <div className="mt-[54px] space-y-8 md:space-y-[80px]">
      {exlopreItem.map((item, idx) => (
        <>
          <div key={item.title} className=" grid items-center grid-cols-2 gap-[80px]">
