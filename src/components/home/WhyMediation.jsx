      ...
      <div className="grid grid-cols-2  gap-[90px] lg:max-w-[1318px] mx-auto">
        ...
        <div className="text-white col-span-2 lg:col-span-1">
          ...
          <p className="font-normal text-base md:text-lg leading-[150%]">
            Every situation is different. That’s why our professional and accredited mediators bring empathy, curiosity and real-world
            experience. With over 25 years of supporting people through conflict, we’re trusted by leading organisations across sectors,
            from SMEs to national bodies, to deliver consistent and effective mediation, navigate difficult conversations, and support
            lasting outcomes. Our diverse team fosters a sense of belonging, ensuring every voice is heard, valued and respected.
          </p>
