  ...
  return (
    <div className="grid grid-cols-1 px-5 lg:grid-cols-2 items-center  gap-[90px] lg:max-w-[1318px] mx-auto">
      <div className="max-h-[500px] max-w-[500px] mx-auto rounded-2xl overflow-hidden">
        <Image alt="Adam" src={Adam} className="w-full h-full object-cover object-center" />
      </div>
      <div className="text-white">
        <p className="font-semibold text-2xl leading-0">Adam Gersch</p>
        <p className=" text-lg my-5"> Founder & CEO</p>
