  ...
  return (
    <section aria-label="Feedback Carousel" className="py-[40px] lg:max-w-[1318px] px-5 md:px-[60px] mx-auto slick-bar ">
      ...
      >
        ...
        {subTitle && <p className=" font-normal text-lg mt-6 md:text-center text-left">{subTitle}</p>}
      </div>
          ...
          {clientReview.map(item => {
            return (
              <div className="px-[15px] mb-[40px]">
                <div className="flex items-center rounded-[10px] bg-white md:rounded-3xl h-[270px] lg:h-[330px] my-[20px] lg:my-9 py-0 px-5 lg:p-[42px] shadow-[10px_10px_55px_0px_rgba(175,172,172,0.25)]">
                  <div>
                    <svg
