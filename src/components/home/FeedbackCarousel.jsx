        ...
        <Slider {...settings}>
          <div className="px-[15px] mb-[40px]">
            <div className=" rounded-[10px] bg-white md:rounded-3xl  my-9 py-6 px-5 lg:p-[42px] shadow-[10px_10px_55px_0px_rgba(175,172,172,0.25)]">
              <svg className="w-[30px] h-[30px] lg:w-[61px] lg:h-[61px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61 61" fill="none">
              ...
              <div className="mt-3 md:mt-[38px] pl-3 md:pl-10 md:pr-5">
                <p className="text-[#656565] leading-[150%] text-sm lg:text-lg mb-5 lg:mb-[100px]">
                ...
                <p className="text-sm lg:text-2xl font-semibold text-[#1C1C1C]">Jenny Wilson - Customer</p>
              </div>
            </div>
          </div>
          <div className="px-[15px] mb-[40px]">
