      ...
      <div className="slider-container">
        <Slider {...settings}>
          <div className="px-[15px] mb-[40px]">
            <div className=" rounded-[10px] bg-white md:rounded-3xl  my-9 py-6 px-5 md:p-[42px] shadow-[10px_10px_55px_0px_rgba(175,172,172,0.25)]">
              <svg className="w-[30px] h-[30px] md:w-[61px] md:h-[61px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61 61" fill="none">
