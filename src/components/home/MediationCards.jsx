...
const MediationCards = () => {
  ...
  useEffect(() => {
    if (!isMobile) {
      const handleScrollProgress = () => {
        ...
        if (progress < 0.2) setActiveCardIndex(0);
        else if (progress < 0.4) setActiveCardIndex(1);
        else if (progress < 0.6) setActiveCardIndex(2);
        else if (progress < 0.8) setActiveCardIndex(3);
    ...
    return (
      <section className="px-5 pb-10 lg:px-16">
        <SectionHeading
          ...
          capitalize={false}
        />
        <div className="mt-12 md:mt-20 grid grid-cols-1 md:grid-cols-5 gap-6">
  ...
  return (
    <div ref={sectionRef} className="relative lg:max-w-[1618px] mx-auto pb-16 h-[300vh]">
      <div className="sticky -top-[10%]  flex items-center justify-center">
        <div className="w-full px-5 lg:px-16">
          <SectionHeading
            ...
            className="mb-8"
          />
          <div className="grid grid-cols-1 mt-[80px] md:grid-cols-5 gap-4">
            {mediationCards.map((card, index) => (
              ...
              <div
                ...
                className={`
        px-[25px] 
        col-span-5 md:col-span-5 lg:col-span-1 
