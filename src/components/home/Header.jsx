...
const Header = () => {
  return (
    ...
    >
      <div className="w-full text-left lg:pl-5 relative z-10 lg:max-w-[700px] mr-auto">
        <h1 className="font-semibold tracking-[-4%] leading-[120%] text-5xl md:[65px] lg:text-[72px] text-white">
          Helping People Move Forward
        </h1>
        <p className="text-white mt-[18px] md:mt-4 mb-[26px] mr-auto md:mb-8 w-[100%] font-normal text-sm md:text-lg">
