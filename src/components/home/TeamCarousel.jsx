...

  {
    ...
    details: (
      <p>
        ...
        supporting owner-managed and family-run businesses. <br />
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        Disagreement in Special Needs (2003). <br />
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        and technology to drive meaningful commercial outcomes. <br />
...
const TeamCarousel = ({ darkText = false, isDouble }) => {
  ...
  const settings = {
    ...
    customPaging: (i) => (
      <div className="w-2  h-2 rounded-full bg-[#F3F1FF]"></div>
    ),
  };
          ...
          {members.map((item) => (
            <div className="px-5 min-h-[250px] lg:px-[25px]   mb-[20px]">
              ...
              <h3
                ...
                } mt-3 truncate md:mt-6 text-2xl md:text-[32px] font-semibold `}>
                {item.name}
              </h3>
              <p
